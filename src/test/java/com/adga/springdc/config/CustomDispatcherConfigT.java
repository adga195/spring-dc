...
import com.adga.springdc.log.SpringLoggerT;
...
public class CustomDispatcherConfigT implements WebMvcConfigurer, EnvironmentAware {
    ...
    @Bean
    public SpringLoggerT customSpringLogger() {

        SpringLoggerT myLogger = new SpringLoggerT();
